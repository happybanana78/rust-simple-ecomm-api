...
use ecomm::app::cart::routes::routes as cart_routes;
use ecomm::app::categories::routes::routes as category_routes;
use ecomm::app::products::routes::routes as products_routes;
